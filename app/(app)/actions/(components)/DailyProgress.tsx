...
export function DailyProgress({ earnedScore }: DailyProgressProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-yellow-50 rounded-3xl shadow-lg border border-yellow-200 p-6 mb-6 animate-in fade-in slide-in-from-top duration-500">
      ...
      <div className="relative">
        ...
        {progressToGoal >= 100 && (
          <div className="absolute -top-1 right-0 flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg animate-bounce">
